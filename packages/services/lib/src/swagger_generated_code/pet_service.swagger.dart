...
import 'pet_service.enums.swagger.dart' as enums;
export 'pet_service.enums.swagger.dart';

part 'pet_service.swagger.chopper.dart';
part 'pet_service.swagger.g.dart';
...
@ChopperApi()
abstract class PetService extends ChopperService {
  static PetService create([ChopperClient? client]) {
    if (client != null) {
      return _$PetService(client);
    }

    final newClient = ChopperClient(
      services: [_$PetService()],
      converter: $JsonSerializableConverter(), /*baseUrl: YOUR_BASE_URL*/
    );
    return _$PetService(newClient);
  }
...
final $jsonDecoder = $CustomJsonDecoder(PetServiceJsonDecoderMappings);
